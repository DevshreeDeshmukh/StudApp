...
public class maths10th extends AppCompatActivity {
    Intent i=null;
    Intent ch=null;
    TabHost host;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maths10th);
    ...
    public void vid3(View view) {
        i = new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("https://youtube.com/c/MathematicsClassX"));
        ch = Intent.createChooser(i, "launch YouTube");
        startActivity(ch);
    }
    ...
    public void Book(View view) {
        i = new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse("https://byjus.com/ncert-books-class-10-maths/"));
